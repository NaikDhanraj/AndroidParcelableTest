...
import com.dssp.androidparcelabletest.adapter.SimpleRecyclerviewAdapter;
import com.dssp.androidparcelabletest.model.Movie;
import com.dssp.androidparcelabletest.util.Constant;
import com.dssp.androidparcelabletest.util.DummyData;
import com.dssp.androidparcelabletest.util.MyLog;
...
public class SimpleRecyclerViewActivity extends AppCompatActivity {
    ...
    private static final String LOG_TAG = SimpleRecyclerViewActivity.class.getSimpleName();
    private Context context = SimpleRecyclerViewActivity.this;
        ...
        **typcasting views
        ...
        simpleRecyclerviewAdapter.setOnRvItemClickListerner(new SimpleRecyclerviewAdapter.OnItemClickListerner1() {
            ...
            public void onItemClick(View itemView, int position) {
                ...
                Toast.makeText(SimpleRecyclerViewActivity.this, " "+moviename, Toast.LENGTH_SHORT).show();

                //passing parcel object
                Intent intent = new Intent(context,SecondActivity.class);
                Movie singleMovieObject = movieList.get(position);
                intent.putExtra(Constant.singleMovie,singleMovieObject);
                startActivity(intent);


/*                //passing parcelable list
                List<Movie> movieListParcel = new ArrayList<Movie>();
                movieListParcel.add(movieList.get(position));
                movieListParcel.add(movieList.get(position));
                Intent intent = new Intent(context,SecondActivity.class);
                intent.putParcelableArrayListExtra(Constant.singleMovie,(ArrayList)movieListParcel);
                startActivity(intent);*/
    ...
    private void toolbarSetup() {
        ...
        toolbar.setTitle("Simple Recyclerview");
    ...
    private void typecastingViews() {
        recyclerViewSimple = (RecyclerView) findViewById(R.id.rv_simple);
